...
import { finalRegisterAdminController, loginAdminController, registerAdminRequestController, verifyAdminOtpController, fetchAdmins, forgotPasswordAdminController, resetPasswordAdminController, logoutAdmin, getAdminRole, changeStatus, deleteStudent, getDeletedStudents, restoreStudent, setStudentBorrowedStatus, extendDueDate, addPenalty } from '../controllers/admins/authAdminsController.js';
import { jwtAuthenticate, verifyAdminToken, refreshToken } from '../middleware/authMiddleware.js';

const router = express.Router();

router.get('/secret11182004/count-admin', fetchAdmins);
